        ...
        <div key={tour._id} className='mb-4 relative'>
          ...
          <div className='bg-white bg-opacity-50 backdrop-blur-lg p-4 rounded-lg shadow-lg grid grid-cols-12 gap-4 max-h-[21rem] overflow-y-auto scroll-container'>
            <div className='col-span-12 md:col-span-6'>
              <img src={getTourImage(tour)} alt='Placeholder' className='w-full h-28 object-cover rounded-lg' />
            </div>
            ...
            <div className='col-span-12'>
              <div className='bg-white bg-opacity-50 backdrop-blur-lg p-6 rounded-lg shadow-lg flex-grow'>
                ...
                <p>
                  <strong>Description:</strong> {formatText(tour.description)}
                </p>
                <p>
                  <strong>Capacity:</strong> {tour.capacity}
                </p>
                <p>
                  <strong>Estimated Duration:</strong> {tour.estimatedDuration}
                </p>
                <p>
                  <strong>Price:</strong> MXN {tour.price}
                </p>
                <p>
                  <strong>Start Dates:</strong> {tour.startDates}
                </p>
                <p>
                  <strong>Itinerary:</strong> {formatText(tour.itinerary)}
                </p>
              </div>
            </div>
          </div>
              ...
              <div className='bg-white bg-opacity-50 backdrop-blur-lg p-4 rounded-lg shadow-lg grid grid-cols-12 gap-4 max-h-[21rem] overflow-y-auto scroll-container'>
                ...
                <div className='col-span-12'>
                  <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-2 p-3 bg-white rounded-lg shadow-md'>
                    ...
                    <div className='text-sm text-gray-600'>
                      <p>
                        <strong>Min Rental Hours:</strong> {vehicle.minRentalHours}
                      </p>
                    </div>
                    <div className='text-sm text-gray-600'>
                      <p>
                        <strong>Price:</strong> MXN {vehicle.price}
                      </p>
                    </div>
                    <div className='text-sm text-gray-600'>
                      <p>
                        <strong>Price per 4 hours:</strong> MXN {vehicle.pricePer4}
                      </p>
                    </div>
                    <div className='text-sm text-gray-600'>
                      <p>
                        <strong>Price per 8 hours:</strong> MXN {vehicle.pricePer8}
                      </p>
                    </div>
                    <div className='text-sm text-gray-600'>
                      <p>
                        <strong>Price per 24 hours:</strong> MXN {vehicle.pricePer24}
                      </p>
                    </div>
                  </div>
                  <Button
          ...
          <div className='bg-white bg-opacity-50 backdrop-blur-lg p-4 rounded-lg shadow-lg grid grid-cols-12 gap-4 max-h-[21rem] overflow-y-auto scroll-container'>
            ...
            <div className='col-span-12 md:col-span-7'>
              <div className='bg-white bg-opacity-50 backdrop-blur-lg p-6 rounded-lg shadow-lg flex-grow'>
                ...
                <p>
                  <strong>Capacity:</strong> {transfer.capacity}
                </p>
                <p>
                  <strong>Estimated Duration:</strong> {transfer.estimatedDuration}
                </p>
                <p>
                  <strong>Price:</strong> MXN {transfer.price}
                </p>
              </div>
            </div>
          </div>
