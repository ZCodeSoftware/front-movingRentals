const ButtonLoader = ({ loadStr, loadEndStr, loadErrorStr, buttonLoad }: any) => {
  return (
    <>
      {buttonLoad.load === true ? (
        <button
          disabled
          type='button'
        ...
        <button
          className='bg-buttonSecondary hover:bg-buttonPrimary font-bold py-2 px-6 rounded focus:outline-none focus:shadow-outline'
          type='submit'
        >
          Enviar
        </button>
